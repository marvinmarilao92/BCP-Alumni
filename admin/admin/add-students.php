<?php
  ...
  include('session.php');
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sqll = "SELECT id FROM student_application ORDER BY id DESC Limit 1";
        if($resultt = mysqli_query($link, $sqll)){
          if(mysqli_num_rows($resultt) == 0){
            $student_number = "" . $current_year . "000001";
          }
          else if(mysqli_num_rows($resultt) > 0){
            while($roww = mysqli_fetch_array($resultt)){
              if($roww['id'] < 9){
                $new_id = $roww['id'] + 1;
                $student_number = "" . $current_year . "00000" . $new_id;
              }
              else if ($roww['id'] == 9){
                $student_number = "" . $current_year . "000010";
              }
              else if ($roww['id'] < 99){
                $new_id = $roww['id'] + 1;
                $student_number = "" . $current_year . "0000" . $new_id;
              }
              else if ($roww['id'] == 99){
                $student_number = "" . $current_year . "000100";
              }
              else if ($roww['id'] < 999){
                $new_id = $roww['id'] + 1;
                $student_number = "" . $current_year . "000" . $new_id;
              }
              else if ($roww['id'] == 999){
                $student_number = "" . $current_year . "001000";
              }
              else if ($roww['id'] < 9999){
                $new_id = $roww['id'] + 1;
                $student_number = "" . $current_year . "00" . $new_id;
              }
              else if ($roww['id'] == 9999){
        ...
        if($count == 0) {
          ...
          if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
              ...
              window.open("add-students.php","add-students","width=500,height=200","position=center");
              </script>';
...
<!DOCTYPE html>
<html lang="en">
<title>Alumni | Add Student</title>
<head>
        ...
        <form class="card" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
              <div class="card-body">
                ...
                <div class="progress mt-3" style="height: 30px;">
                    <div class="progress-bar progress-bar-striped bg-success progress-bar-animated"  id="progress" role="progressbar" style="width: 0%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"><h5 id="percent"></h5></div>
                  </div>
                </h5>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        ...
                        <a class="accordion-button" id="accordion1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"  aria-expanded="true" aria-controls="collapseOne" style="pointer-events: none;">
                          <div class="icon" >
                            <h6 id="text1" style="color: rgb(27, 153, 94); font-weight: bold;"><i class="" id="icon1"></i>Personal Information</h6>
                          </div>
                        </a>
                        <!-- End of button -->
                      </h2>
                          ...
                          <div class="accordion-body row g-3">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="text-right">                          
                                <a class="btn btn-success collapsed" type="button" id="next" onclick="nextFunction()" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="margin-top: 10px;">NEXT</a>                              
                                </div>
                              </button>
                          </div>
                        </div>            
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingTwo">
                        ...
                        <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="pointer-events: none;">
                          <div class="icon">
                            <h6 id="text2" style="color: rgb(27, 153, 94); font-weight: bold;"><i class="" id="icon2"></i>Address</h6>
                          </div>
                        </a>
                        <!-- End of button -->
                      </h2>
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                          ...
                          <!-- Multi Columns Address Form -->
                            <div class="row g-3">
                              ...
                              <div class="text-right">                            
                                <a type="reset" class="btn btn-success collapsed" id="next2" onclick="next2Function()" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">NEXT</a>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingThree">
                        ...
                        <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="pointer-events: none;"> 
                          <div class="icon">
                            <h6 id="text3" style="color: rgb(27, 153, 94); font-weight: bold;"><i class="" id="icon3"></i>Contact Infomration</h6>
                          </div>                   
                        </a>
                        <!-- End of button -->
                      </h2>
                      <!-- third part of fill out form -->                        
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                          <div class="accordion-body row g-3">
                            ...
                            <div class="text-right">                            
                                <button type="submit" class="btn btn-success" onclick="next3Function()">Submit</button>
