          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php 
                        require_once("include/conn.php");
                        $query="SELECT * FROM user_information WHERE `department` = 'User Management'";
                        $result=mysqli_query($conn,$query);
                        if($result){
                          echo "<h6>". mysqli_num_rows($result)."</h6>";
                        }
              ...
              <div class="card info-card customers-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="students.php">Show</a></li>
                  </ul>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php 
                      ...
                      ?> 
                      <span class="text-danger small pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">Number of Students</span>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <!-- Bar Chart -->
                <div class="card-body">
                  <h5 class="card-title">Number of Students<span></span></h5>
                <canvas id="barChart" style="max-height: 400px;"></canvas>
                 <?php
                       require_once("include/conn.php");

                             $sql ="SELECT *,count(course) as count FROM student_application group by course;";
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            <div class="card-body pb-0">
              <h5 class="card-title">Number of Accounts <span>| Per Office</span></h5>

              <canvas id="accountChart" style="height: 400px; margin-bottom: 30px;" class="echart"></canvas>
                  <?php
                    require_once("include/conn.php");
                        $sql1 ="SELECT *,count(office) as count FROM user_information WHERE department='User Management' group by office;";
